...
document.addEventListener('click', function(e) {
  ...
  if (e.target.closest('.ticketBorder')) {
    ...
    if (customContainer) {
      ...
      // Adiciona um atraso de 1 segundo (1000 milissegundos) antes de chamar execucao()
      setTimeout(function() {
        execucao();
      }, 2000);
    } else {
